...
namespace DapperExtensions
{
    public static partial class DapperExtension
    {
        ...
        {
            var builder = BuilderFactory.GetBuilder(conn);
            return await conn.ExecuteAsync(builder.UpdateByWhereSql<T>(where, updateFields), model, tran, commandTimeout, commandType);
        }
        ...
        {
            var builder = BuilderFactory.GetBuilder(conn);
            return await conn.ExecuteAsync(builder.DeleteByIdSql<T>(), new { id = id }, tran, commandTimeout, commandType);
        }
        ...
        public static async Task<int> DeleteByIdsAsync<T>(this IDbConnection conn, object ids, IDbTransaction tran = null, int? commandTimeout = null, CommandType? commandType = null)
        {
            ...
            dpar.Add("@ids", ids);
            return await conn.ExecuteAsync(builder.DeleteByIdsSql<T>(), dpar, tran, commandTimeout, commandType);
        }
